...
class StudyTracker 
{
    ...
    public void summarybydate()
    {
        ...
        if(database.isEmpty())
        {
            System.out.println("Nothing to display as the data base is empty ");
            System.out.println("------------------------------------------------------------------");
            return;
        }
        System.out.println("Summary of date form the study tracker :");
        System.out.println("------------------------------------------------------------------");
        ...
        {
            System.out.println("Date : " + l + " Total stusy duration : " + tobj.get(l));
        }
    ...
    public void summarybysubject()
    {
        ...
        System.out.println("Summary of subject form the study tracker :");
        System.out.println("------------------------------------------------------------------");
        ...
        {
            System.out.println("Subjet : " + str + " Total stusy duration : " + tobj.get(str));
        }
